  ...
  return (
    <section>
      ...
      {/* Set-password modal — for when the invite email can't be relied on;
          activates the account immediately with a Head-chosen password
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy-950/50 p-4" onClick={() => setPwFor(null)}>
          <div className="w-full max-w-md rounded-lg border border-line bg-white p-5" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="mb-3 text-xs text-muted">
              {pwFor.email} — {L('ईमेल भेजे बिना खाता तुरंत सक्रिय हो जाएगा। यह उपयोगकर्ता को दें ताकि वे साइन इन कर सकें।', "Activates the account immediately, no email sent. Share this password with them so they can sign in.")}
            </p>
