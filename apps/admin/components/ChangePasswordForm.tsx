 ...
 *  reset flow) — so on success we send the staff member back to sign in
 *  again, rather than leaving them on a page whose session is about to die. */
  ...
  if (done) {
    return (
      <div className="grid gap-3">
        ...
        <a href={`/${locale}/admin/login`} className="inline-flex min-h-[42px] items-center justify-center rounded-md bg-orange-500 px-4 text-sm font-extrabold text-white hover:bg-orange-600">
