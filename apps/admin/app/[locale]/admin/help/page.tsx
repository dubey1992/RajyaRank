...
export default async function AdminHelpPage({ params }: { params: { locale: string } }) {
  ...
  const faqs = [
    ...
    { q: L('दो-चरणीय सत्यापन (MFA) कैसे सेट करें?', 'How do I set up two-factor authentication (MFA)?'), a: L('Profile पेज पर जाएं और "दो-चरणीय सत्यापन सेट करें" पर क्लिक करें। किसी authenticator ऐप (Google Authenticator, Authy, या पासवर्ड मैनेजर) से QR कोड स्कैन करें, या मैन्युअल की डालें, फिर पुष्टि के लिए ऐप में दिख रहा 6-अंकों का कोड डालें। इसके बाद हर साइन इन पर यह कोड माँगा जाएगा — अपने कंप्यूटर पर बार-बार न पूछे जाने के लिए लॉगिन के समय "इस डिवाइस पर 60 दिनों तक याद रखें" चुन सकते हैं।', 'Go to your Profile page and click "Set up two-factor authentication". Scan the QR code with an authenticator app (Google Authenticator, Authy, or a password manager) — or enter the manual key — then confirm with the 6-digit code your app shows. After that, every sign-in will ask for a code from your app; check "Trust this device for 60 days" at login to skip repeated prompts on your own computer.') },
