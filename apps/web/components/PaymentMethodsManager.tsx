  ...
  return (
    <section className="rounded-[18px] border border-line bg-white p-5 shadow-[0_7px_22px_rgba(6,29,49,0.04)]">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-base font-black tracking-tight text-navy-950">{L('भुगतान माध्यम', 'Payment methods')}</h2>
      ...
      {cards.length === 0 ? (
        ...
        <ul className="grid gap-2 text-sm">
          {cards.map((c) => (
            <li key={c.id} className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-line bg-white p-3">
              ...
              <span className="flex gap-2">
                {!c.isDefault ? (
                  <button
                    ...
                    className="rounded-md border border-line px-2 py-1 text-[11px] font-bold hover:bg-surface-soft disabled:opacity-50"
                  >
                ...
                <button
                  ...
                  className="rounded-md border border-line px-2 py-1 text-[11px] font-bold text-danger hover:bg-surface-soft disabled:opacity-50"
                >
                  {L('हटाएँ', 'Remove')}
                </button>
              </span>
